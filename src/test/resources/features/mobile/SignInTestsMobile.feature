@web @newlook @UserDependentMobile
Feature: SignIn - Mobile

  Background:
    Given i navigate to "Newlook" home page

  Scenario:1 Validate the SignIn page - mobile
  ...
  Scenario:2 SingIn using correct user credentials - mobile
    And Navigate to singIn page
    When Correct user credentials are entered
    Then User should navigate to my account

  Scenario Outline:3 SingIn using wrong user credentials - mobile
    And Navigate to singIn page
