@AnonymousMobile
Feature: StoreLocator feature  - Mobile

	Background: I go to New Looks home page
		Given i navigate to "Newlook" home page

	Scenario Outline:1a) Country has been preset to selected country on the store locator page - Mobile
	...
	Scenario Outline:1b) Country has been preset to selected country on the store locator page - Mobile
		And I click on the locale selector in the header
		And I select a different country <country> using the drop down
		When I can click the link of store locator on mobile
		And my "<expText>" is preset for me underneath
	...
	Scenario Outline:2 As a Customer, I want to search for stores by postcode or town, so that I can find the one nearest to that criteria - Mobile
		And I click on the locale selector in the header
		And I select a different country <country> using the drop down
		When I can click the link of store locator on mobile
	...
	Scenario Outline:3 As a Customer, I want to search for stores by postcode or town, that is configured or located within the radius distance - Mobile
	...
	Scenario:4 The search results should have the key word along with the total results - Mobile
		When I can click the link of store locator on mobile
	...
	Scenario:5 The total number of search results should not be more than ten - Mobile
		When I can click the link of store locator on mobile
		And I enter a search term "London"
		And I click on Find Stores CTA

	Scenario:6 search again link should navigate back to the store finder page - Mobile
		When I can click the link of store locator on mobile
		And I enter a search term "London"
		And I click on Find Stores CTA
	...
	Scenario:7 The more info should display name, address ,phone number,distance form serach location information - Mobile
		When I can click the link of store locator on mobile
		And I enter a search term "London"
		And I click on Find Stores CTA
		Then click on moreinfo link

	Scenario:8 On clicking back to results link from store info page , it should go back to the results page - Mobile
		When I can click the link of store locator on mobile
		And I enter a search term "London"
		And I click on Find Stores CTA
		Then click on moreinfo link
	...
	Scenario:9 Error message should be displayed if nothing enterd in the store finder and clicked on find store - Mobile
		When I can click the link of store locator on mobile
		And I click on Find Stores CTA
		Then you should see error message displayed

	@Ignore
	Scenario:10 On clicking near by button it should display location based on default selection or geo location - Mobile
		When I can click the link of store locator on mobile
		And click on near by button
		Then the page reloads and a store results page is displayed

	Scenario Outline:11 Default language should be English for UK, French for France, German for Germany and English for Rest of the world - Mobile
		And I click on the locale selector in the header
		And I select a different country <country> using the drop down
	...
	Scenario:12 User should see map contents when search for Store locations in store finder page - Mobile
	...
	Scenario:13 User should see pins in map when search for store locations - Mobile
		And customer navigate to store finder page
		When search for London in store finder page
		Then Store finder page should show map pins

	Scenario Outline:14 User should see pins in map when search for store in store location page - Mobile
		And customer navigate to store finder page
	...
	Scenario Outline:15 Results should match when we click the pin in map - Mobile
		And customer navigate to store finder page
		When search for <location> in store finder page
