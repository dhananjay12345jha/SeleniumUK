...
Feature: Shop Multi PDP Information
  ...
  Background:
    ...
    When search and select the product "363066817" with the perfect partner

  Scenario:1) Check that only primary product on Multi-PDP has Product Details & Care Guide information - mobile
    And click on the searched product name
    Then I should see Product details and Care Guide


  Scenario:2) click Show more - mobile
    And click on the searched product name
    And click on show more to expand
    Then product info details exists

  Scenario:3) click Show less - mobile
    And click on the searched product name
    And click on show more to expand
...
#    Then review is only for main product
  ...
  Scenario Outline:7)Check that email is pre-populated for registered user when pre-orderable and back-orderable box are presented and normal PDP - mobile
  ...
  Scenario Outline:8)Check that email is not populated for unsigned user when pre-orderable and back-orderable box are presented and normal PDP - mobile
	 And feature "feature.storefront.stock.urgency.messaging.pdp" is switched off
    And search and select the product "363066817" with the perfect partner
    And click on the searched product name
    And select size of the product "<Item Size>"
  ...
  Scenario: 10) Save Multi Pdp items and view side pane - mobile
    And click on the searched product name
  ...
  Scenario: 11) Save Multi Pdp items amd view full page - mobile
    And click on the searched product name
    And save 3 multi pdp items
    And viewing saved items on full page
    Then my saved items page has 3 products and "MOVE ALL TO BAG" button

  Scenario: 12) Save and then remove remove Multi Pdp items and view side pane - mobile
    And click on the searched product name
    And save 3 multi pdp items
  ...
  Scenario: 13) Save and then remove Multi Pdp items amd view full page - mobile
    And click on the searched product name
    And save 3 multi pdp items
  ...
  Scenario Outline: 14) Check if the stock information for the searched result displays on the side-panel for multi pdp - mobile
	 And feature "feature.storefront.stock.urgency.messaging.pdp" is switched off
  ...
  Scenario: 15) Add secong multi pdp item to bag and assert confirmation message - mobile
    And click on the searched product name
    And add the 2 product to the bag
