...
Feature: Delivery Pass
  ...
  Scenario:1 anonymous customer registers to add delivery pass
  ...
  Scenario:2 logged out registered customer adds delivery pass
  ...
  Scenario:3 registered customer adds delivery pass
    And customer already has an account
    And user goes to Delivery Pass page
  ...
  Scenario: Validate delivery pass page
  ...
  Scenario:5 Add delivery pass
    ...
    And customer see Delivery Pass confirmation
	 ...
	 And wait till order with status "Dispatched"
    And user search and checkout a product
    Then delivery pass is applied

	Scenario:6 Add delivery pass - PCI micro forms
